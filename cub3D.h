...
/*   Updated: 2026/02/06 12:21:52 by kadferna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				img_setup(t_data *data, t_img *image, int width,
						int height);
...
/*render.c*/
void				set_frame_image_pixel(t_data *data, t_img *image, int x,
						int y);
...
void				free_n_err_file(t_data *data, int lvl, char *msg,
						char *file_path);
